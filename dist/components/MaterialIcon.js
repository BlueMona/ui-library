...
class MaterialIcon extends react_1.default.Component {
    render() {
        return (react_1.default.createElement("span", { className: classnames_1.default("material-icons", this.props.className, { active: this.props.active }), onClick: this.props.onClick },
            this.props.icon,
            this.props.tooltip
