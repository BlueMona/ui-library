...
let Dropdown = class Dropdown extends React.Component {
    ...
    render() {
        ...
        for (let i = 0; i < options.length; i++) {
            dropdownOptions.push(React.createElement("li", { key: options[i].value, "data-value": options[i].value, onClick: this.setValue }, options[i].label));
        ...
        return (React.createElement("div", { className: classNames },
            this.props.label &&
                React.createElement("span", { className: "label" },
                    this.props.label,
                    ":"),
            React.createElement("div", { className: "inputs-container", onMouseEnter: this.handleMouseEnter, onMouseLeave: this.handleMouseLeave },
                React.createElement("div", { className: "selector clickable", onClick: this.activate },
                    React.createElement("span", { className: "input" }, labels[value]),
                    React.createElement("span", { className: "material-icons" }, "arrow_drop_down")),
                this.isActive &&
                    React.createElement("ul", { className: this.isActive ? "active" : undefined }, dropdownOptions))));
    }
};
__decorate([
    observable,
