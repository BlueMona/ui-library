    ...
    render() {
        return (react_1.default.createElement("div", { className: classnames_1.default('p-input', this.props.className, this.props.theme, this.props.size, {
            ...
            react_1.default.createElement("div", { className: "input-container" },
                this.props.multiline ? (react_1.default.createElement("textarea", { id: this.props.inputId, "data-test-id": this.props.testId, placeholder: this.props.placeholder, value: this.props.value, maxLength: this.props.maxLength, onChange: this.props.onChange ? this.handleChange : undefined, onKeyPress: this.props.onKeyPress, onKeyDown: this.props.onKeyDown, onKeyUp: this.props.onKeyUp, onBlur: this.handleBlur, onFocus: this.handleFocus, readOnly: this.props.readOnly, ref: this.setRef })) : (react_1.default.createElement("input", { id: this.props.inputId, "data-test-id": this.props.testId, placeholder: this.props.placeholder, value: this.props.value, maxLength: this.props.maxLength, onChange: this.props.onChange ? this.handleChange : undefined, onKeyPress: this.props.onKeyPress, onKeyDown: this.props.onKeyDown, onKeyUp: this.props.onKeyUp, onBlur: this.handleBlur, onFocus: this.handleFocus, type: this.props.type || 'text', readOnly: this.props.readOnly, disabled: this.props.disabled, ref: this.setRef })),
