...
class Button extends react_1.default.Component {
    render() {
        ...
        const buttonContent = [
            ...
            this.props.label || this.props.children ? (react_1.default.createElement("span", { key: `button-label-${this.props.label || this.props.children}`, "data-test-id": this.props.testId, className: "label" }, this.props.label || this.props.children)) : null,
